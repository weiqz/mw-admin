      ...
      <el-table ref="multipleTable"
        ...
        <el-table-column prop="data"
          ...
          <template slot-scope="scope">
            <el-switch v-model="scope.row.data"
                       inactive-text="上架:">
            </el-switch>
        ...
        <el-table-column prop="pro_sales"
                         label="销量"
                         show-overflow-tooltip></el-table-column>
        <el-table-column prop="pro_time"
                         label="创建时间"
                         width="120"></el-table-column>
        <el-table-column prop="address"
                         ...
                         show-overflow-tooltip>
          <template slot-scope="scope">
            <router-link :to="{name:'productwatch',paramas:{id:scope.row.id}}">查看</router-link>
            <el-button type="text"
...
<script>
import dialogk from "../../components/dialog"
export default {
  data () {
    return {
    currentPage4:0,
